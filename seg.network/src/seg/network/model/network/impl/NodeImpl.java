...
public class NodeImpl extends EObjectImpl implements Node {
	...
	public EList getUpstreamLinks() {
		if (upstreamLinks == null) {
			upstreamLinks = new EObjectResolvingEList(Link.class, this, NetworkPackage.NODE__UPSTREAM_LINKS);
		}
	...
	public EList getDownstreamLinks() {
		if (downstreamLinks == null) {
			downstreamLinks = new EObjectResolvingEList(Link.class, this, NetworkPackage.NODE__DOWNSTREAM_LINKS);
		}
