 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ConditionImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ConditionImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ConditionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ConditionImpl#getStartPoint <em>Start Point</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ConditionImpl#getEndPoint <em>End Point</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ConditionImpl#getPluginBinding <em>Plugin Binding</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ConditionImpl#getNodeConnection <em>Node Connection</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ConditionImpl#getConcern <em>Concern</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ConditionImpl#getScenarioDefPre <em>Scenario Def Pre</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ConditionImpl#getScenarioDefPost <em>Scenario Def Post</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
