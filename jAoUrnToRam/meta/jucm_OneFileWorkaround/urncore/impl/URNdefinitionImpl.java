 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.URNdefinitionImpl#getUrnspec <em>Urnspec</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.URNdefinitionImpl#getResponsibilities <em>Responsibilities</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.URNdefinitionImpl#getSpecDiagrams <em>Spec Diagrams</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.URNdefinitionImpl#getConcerns <em>Concerns</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.URNdefinitionImpl#getComponents <em>Components</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.URNdefinitionImpl#getComponentTypes <em>Component Types</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class URNdefinitionImpl extends EObjectImpl implements URNdefinition {
	 ...
	 * @ordered
	 */
	protected EList<IURNDiagram> specDiagrams;
	...
	public EList<Responsibility> getResponsibilities() {
		if (responsibilities == null) {
			responsibilities = new EObjectContainmentWithInverseEList<Responsibility>(Responsibility.class, this, UrncorePackage.UR_NDEFINITION__RESPONSIBILITIES, UrncorePackage.RESPONSIBILITY__URNDEFINITION);
		}
	 ...
	 * @generated
	 */
	public EList<IURNDiagram> getSpecDiagrams() {
		if (specDiagrams == null) {
			specDiagrams = new EObjectContainmentWithInverseEList<IURNDiagram>(IURNDiagram.class, this, UrncorePackage.UR_NDEFINITION__SPEC_DIAGRAMS, UrncorePackage.IURN_DIAGRAM__URNDEFINITION);
		}
		return specDiagrams;
	}
	...
	public EList<Concern> getConcerns() {
		if (concerns == null) {
			concerns = new EObjectContainmentWithInverseEList<Concern>(Concern.class, this, UrncorePackage.UR_NDEFINITION__CONCERNS, UrncorePackage.CONCERN__URNDEFINITION);
		}
		return concerns;
	}
	...
	public EList<Component> getComponents() {
		if (components == null) {
			components = new EObjectContainmentWithInverseEList<Component>(Component.class, this, UrncorePackage.UR_NDEFINITION__COMPONENTS, UrncorePackage.COMPONENT__URNDEFINITION);
		}
		return components;
	}
	...
	public EList<ComponentType> getComponentTypes() {
		if (componentTypes == null) {
			componentTypes = new EObjectContainmentWithInverseEList<ComponentType>(ComponentType.class, this, UrncorePackage.UR_NDEFINITION__COMPONENT_TYPES, UrncorePackage.COMPONENT_TYPE__URNDEFINITION);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case UrncorePackage.UR_NDEFINITION__SPEC_DIAGRAMS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getSpecDiagrams()).basicAdd(otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case UrncorePackage.UR_NDEFINITION__SPEC_DIAGRAMS:
				...
				getSpecDiagrams().addAll((Collection<? extends IURNDiagram>)newValue);
				return;
			case UrncorePackage.UR_NDEFINITION__CONCERNS:
				getConcerns().clear();
