 ...
 * $Id$
 */
package jucm_OneFileWorkaround.urncore.impl;

import java.util.Collection;

import jucm_OneFileWorkaround.ucm.performance.PassiveResource;
import jucm_OneFileWorkaround.ucm.performance.PerformancePackage;
...
import jucm_OneFileWorkaround.urncore.ComponentType;
 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ComponentImpl#getLineColor <em>Line Color</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ComponentImpl#getFillColor <em>Fill Color</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ComponentImpl#isFilled <em>Filled</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ComponentImpl#getContRefs <em>Cont Refs</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ComponentImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ComponentImpl#isProtected <em>Protected</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ComponentImpl#isSlot <em>Slot</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ComponentImpl#isContext <em>Context</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ComponentImpl#getType <em>Type</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ComponentImpl#getUrndefinition <em>Urndefinition</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ComponentImpl#getIncludedComponent <em>Included Component</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ComponentImpl#getIncludingComponent <em>Including Component</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ComponentImpl#getResource <em>Resource</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ComponentImpl#getHost <em>Host</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComponentImpl extends UCMmodelElementImpl implements Component {
	...
	public boolean isSystem() {
		if(getKind()==ComponentKind.ACTOR) 
			return false;
		else
			return recurseIncludingComponentIsSystem();
	}

	@Override
	public boolean recurseIncludingComponentIsSystem() {
		if(getIncludingComponent() == null) 
			return getKind() != ComponentKind.ACTOR;
		else
			return getIncludingComponent().isSystem();
	}
	 ...
	 * @ordered
	 */
	protected EList<Component> includedComponent;
	...
	public EList<IURNContainerRef> getContRefs() {
		if (contRefs == null) {
			contRefs = new EObjectWithInverseResolvingEList<IURNContainerRef>(IURNContainerRef.class, this, UrncorePackage.COMPONENT__CONT_REFS, UrncorePackage.IURN_CONTAINER_REF__CONT_DEF);
		}
		return contRefs;
	}
	 ...
	 * @generated
	 */
	public EList<Component> getIncludedComponent() {
		if (includedComponent == null) {
			includedComponent = new EObjectWithInverseResolvingEList<Component>(Component.class, this, UrncorePackage.COMPONENT__INCLUDED_COMPONENT, UrncorePackage.COMPONENT__INCLUDING_COMPONENT);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case UrncorePackage.COMPONENT__INCLUDED_COMPONENT:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getIncludedComponent()).basicAdd(otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case UrncorePackage.COMPONENT__INCLUDED_COMPONENT:
				...
				getIncludedComponent().addAll((Collection<? extends Component>)newValue);
				return;
			case UrncorePackage.COMPONENT__INCLUDING_COMPONENT:
