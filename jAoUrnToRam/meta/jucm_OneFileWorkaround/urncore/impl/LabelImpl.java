 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.LabelImpl#getDeltaX <em>Delta X</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.LabelImpl#getDeltaY <em>Delta Y</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class LabelImpl extends EObjectImpl implements Label {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case UrncorePackage.LABEL__DELTA_X:
				setDeltaX((Integer)newValue);
				return;
			case UrncorePackage.LABEL__DELTA_Y:
				setDeltaY((Integer)newValue);
				return;
		}
