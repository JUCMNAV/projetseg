 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.URNmodelElementImpl#getFromLinks <em>From Links</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.URNmodelElementImpl#getToLinks <em>To Links</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.URNmodelElementImpl#getId <em>Id</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.URNmodelElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.URNmodelElementImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.URNmodelElementImpl#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.URNmodelElementImpl#getInconcern <em>Inconcern</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class URNmodelElementImpl extends EObjectImpl implements URNmodelElement {
	public String nameOrPrefixId(String prefix) {
		if(getName() == null || getName().equals("")){
			return prefix + getId();
		} else {
			String res = jAoUrnToRam.util.StringExtensions.replaceSpaceByUnderscore(getName());
			res = jAoUrnToRam.util.StringExtensions.capitalizaFirtLetter(res);
			return res;
		}
	}
	/**
	 ...
	 * @ordered
	 */
	protected EList<URNlink> fromLinks;
	 ...
	 * @ordered
	 */
	protected EList<URNlink> toLinks;
	 ...
	 * @generated
	 */
	public EList<URNlink> getFromLinks() {
		if (fromLinks == null) {
			fromLinks = new EObjectWithInverseResolvingEList<URNlink>(URNlink.class, this, UrncorePackage.UR_NMODEL_ELEMENT__FROM_LINKS, UrnPackage.UR_NLINK__FROM_ELEM);
		}
		return fromLinks;
	}
	 ...
	 * @generated
	 */
	public EList<URNlink> getToLinks() {
		if (toLinks == null) {
			toLinks = new EObjectWithInverseResolvingEList<URNlink>(URNlink.class, this, UrncorePackage.UR_NMODEL_ELEMENT__TO_LINKS, UrnPackage.UR_NLINK__TO_ELEM);
		}
		return toLinks;
	}
	...
	public EList<Metadata> getMetadata() {
		if (metadata == null) {
			metadata = new EObjectContainmentEList<Metadata>(Metadata.class, this, UrncorePackage.UR_NMODEL_ELEMENT__METADATA);
		}
		return metadata;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UrncorePackage.UR_NMODEL_ELEMENT__FROM_LINKS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getFromLinks()).basicAdd(otherEnd, msgs);
			case UrncorePackage.UR_NMODEL_ELEMENT__TO_LINKS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getToLinks()).basicAdd(otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case UrncorePackage.UR_NMODEL_ELEMENT__FROM_LINKS:
				getFromLinks().clear();
				getFromLinks().addAll((Collection<? extends URNlink>)newValue);
				return;
			case UrncorePackage.UR_NMODEL_ELEMENT__TO_LINKS:
				getToLinks().clear();
				getToLinks().addAll((Collection<? extends URNlink>)newValue);
				return;
			case UrncorePackage.UR_NMODEL_ELEMENT__ID:
