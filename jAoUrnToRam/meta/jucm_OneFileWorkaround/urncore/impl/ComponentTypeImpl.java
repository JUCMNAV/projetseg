 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ComponentTypeImpl#getInstances <em>Instances</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ComponentTypeImpl#getUrndefinition <em>Urndefinition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComponentTypeImpl extends UCMmodelElementImpl implements ComponentType {
	...
	public EList<Component> getInstances() {
		if (instances == null) {
			instances = new EObjectWithInverseResolvingEList<Component>(Component.class, this, UrncorePackage.COMPONENT_TYPE__INSTANCES, UrncorePackage.COMPONENT__TYPE);
		}
		return instances;
	}
