 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ConcernImpl#getUrndefinition <em>Urndefinition</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ConcernImpl#getSpecDiagrams <em>Spec Diagrams</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ConcernImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urncore.impl.ConcernImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConcernImpl extends URNmodelElementImpl implements Concern {
	//Extension
	private IwConcern iwConcern;
	@Override
	public void build() {
		iwConcern = IntermediateWorkflowFactory.eINSTANCE.createIwConcern();
		iwConcern.setName(nameOrPrefixId("Concern"));
	}

	@Override
	public void link() {
		if(iwConcern.getWorkflows().size()>0) 
			iwConcern.setModel(urnSpec().iwModel());
	}
	...
	public EList<IURNDiagram> getSpecDiagrams() {
		if (specDiagrams == null) {
			specDiagrams = new EObjectWithInverseResolvingEList<IURNDiagram>(IURNDiagram.class, this, UrncorePackage.CONCERN__SPEC_DIAGRAMS, UrncorePackage.IURN_DIAGRAM__CONCERN);
		}
		return specDiagrams;
	}
	...
	public EList<URNmodelElement> getElements() {
		if (elements == null) {
			elements = new EObjectWithInverseResolvingEList<URNmodelElement>(URNmodelElement.class, this, UrncorePackage.CONCERN__ELEMENTS, UrncorePackage.UR_NMODEL_ELEMENT__INCONCERN);
		}
		return elements;
	}
