 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.ucm.performance.impl.ExternalOperationImpl#getDemands <em>Demands</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExternalOperationImpl extends ActiveResourceImpl implements ExternalOperation {
	...
	public EList<Demand> getDemands() {
		if (demands == null) {
			demands = new EObjectWithInverseResolvingEList<Demand>(Demand.class, this, PerformancePackage.EXTERNAL_OPERATION__DEMANDS, PerformancePackage.DEMAND__RESOURCE);
		}
		return demands;
	}
