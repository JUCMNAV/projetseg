 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.ucm.performance.impl.ProcessingResourceImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.performance.impl.ProcessingResourceImpl#getComponents <em>Components</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessingResourceImpl extends ActiveResourceImpl implements ProcessingResource {
	 ...
	 * @ordered
	 */
	protected static final DeviceKind KIND_EDEFAULT = DeviceKind.PROCESSOR;
	...
	public EList<Component> getComponents() {
		if (components == null) {
			components = new EObjectWithInverseResolvingEList<Component>(Component.class, this, PerformancePackage.PROCESSING_RESOURCE__COMPONENTS, UrncorePackage.COMPONENT__HOST);
		}
		return components;
	}
