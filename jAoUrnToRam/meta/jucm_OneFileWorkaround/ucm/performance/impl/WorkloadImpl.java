 ...
 * $Id$
 */
package jucm_OneFileWorkaround.ucm.performance.impl;

import jucm_OneFileWorkaround.ucm.map.MapPackage;
import jucm_OneFileWorkaround.ucm.map.StartPoint;

import jucm_OneFileWorkaround.ucm.performance.ArrivalProcess;
import jucm_OneFileWorkaround.ucm.performance.PerformancePackage;
import jucm_OneFileWorkaround.ucm.performance.TimeUnit;
 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.ucm.performance.impl.WorkloadImpl#isClosed <em>Closed</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.performance.impl.WorkloadImpl#getArrivalPattern <em>Arrival Pattern</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.performance.impl.WorkloadImpl#getArrivalParam1 <em>Arrival Param1</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.performance.impl.WorkloadImpl#getArrivalParam2 <em>Arrival Param2</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.performance.impl.WorkloadImpl#getExternalDelay <em>External Delay</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.performance.impl.WorkloadImpl#getValue <em>Value</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.performance.impl.WorkloadImpl#getCoeffVarSeq <em>Coeff Var Seq</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.performance.impl.WorkloadImpl#getPopulation <em>Population</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.performance.impl.WorkloadImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.performance.impl.WorkloadImpl#getStartPoint <em>Start Point</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WorkloadImpl extends UCMmodelElementImpl implements Workload {
	 ...
	 * @ordered
	 */
	protected static final ArrivalProcess ARRIVAL_PATTERN_EDEFAULT = ArrivalProcess.POISSON_PDF;
