 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.ucm.scenario.impl.EnumerationTypeImpl#getValues <em>Values</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.scenario.impl.EnumerationTypeImpl#getUcmspec <em>Ucmspec</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.scenario.impl.EnumerationTypeImpl#getInstances <em>Instances</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumerationTypeImpl extends UCMmodelElementImpl implements EnumerationType {
	 ...
	 * @ordered
	 */
	protected EList<Variable> instances;
	 ...
	 * @generated
	 */
	public EList<Variable> getInstances() {
		if (instances == null) {
			instances = new EObjectWithInverseResolvingEList<Variable>(Variable.class, this, ScenarioPackage.ENUMERATION_TYPE__INSTANCES, ScenarioPackage.VARIABLE__ENUMERATION_TYPE);
		}
		return instances;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ScenarioPackage.ENUMERATION_TYPE__INSTANCES:
				getInstances().clear();
				getInstances().addAll((Collection<? extends Variable>)newValue);
				return;
		}
