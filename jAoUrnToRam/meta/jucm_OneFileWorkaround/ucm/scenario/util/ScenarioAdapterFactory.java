 ...
 * $Id$
 */
package jucm_OneFileWorkaround.ucm.scenario.util;

import jucm_OneFileWorkaround.ucm.scenario.*;
 ...
 * <!-- end-user-doc -->
 * @see jucm_OneFileWorkaround.ucm.scenario.ScenarioPackage
 * @generated
 */
public class ScenarioAdapterFactory extends AdapterFactoryImpl {
	...
	protected ScenarioSwitch<Adapter> modelSwitch =
		new ScenarioSwitch<Adapter>() {
			...
			@Override
			public Adapter caseScenarioStartPoint(ScenarioStartPoint object) {
				return createScenarioStartPointAdapter();
			}
			@Override
			public Adapter caseScenarioEndPoint(ScenarioEndPoint object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link jucm_OneFileWorkaround.ucm.scenario.Variable <em>Variable</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link jucm_OneFileWorkaround.ucm.scenario.ScenarioDef <em>Def</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link jucm_OneFileWorkaround.ucm.scenario.ScenarioGroup <em>Group</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link jucm_OneFileWorkaround.ucm.scenario.EnumerationType <em>Enumeration Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link jucm_OneFileWorkaround.ucm.scenario.Initialization <em>Initialization</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link jucm_OneFileWorkaround.ucm.scenario.ScenarioStartPoint <em>Start Point</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link jucm_OneFileWorkaround.ucm.scenario.ScenarioEndPoint <em>End Point</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
