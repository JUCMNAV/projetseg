 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.Stub#isDynamic <em>Dynamic</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.Stub#isShared <em>Shared</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.Stub#getRepetitionCount <em>Repetition Count</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.Stub#isPointcut <em>Pointcut</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.Stub#isSynchronization <em>Synchronization</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.Stub#isBlocking <em>Blocking</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.Stub#getAopointcut <em>Aopointcut</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.Stub#getAspect <em>Aspect</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.Stub#getBindings <em>Bindings</em>}</li>
 * </ul>
 * </p>
 *
 * @see jucm_OneFileWorkaround.ucm.map.MapPackage#getStub()
 * @model
 * @generated
 */
public interface Stub extends PathNode {
	StubStrategy getStrategy();
	//boolean iwHasNodes();
	//IwNode iwGetEntryNode(NodeConnection nodeConnection);
	//IwNode iwGetExitNode(NodeConnection nodeConnection);
	void addIwPluginBinding(IwPluginBinding iwPluginBinding);
	boolean isRegularStub();
	boolean isPointcutStub();
	 ...
	 * @see jucm_OneFileWorkaround.ucm.map.MapPackage#getStub_Dynamic()
	 * @model default="false"
	 * @generated
	 */
	boolean isDynamic();
	...
	/**
	 * Sets the value of the '{@link jucm_OneFileWorkaround.ucm.map.Stub#isDynamic <em>Dynamic</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see jucm_OneFileWorkaround.ucm.map.MapPackage#getStub_Shared()
	 * @model default="false"
	 * @generated
	 */
	boolean isShared();
	...
	/**
	 * Sets the value of the '{@link jucm_OneFileWorkaround.ucm.map.Stub#isShared <em>Shared</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see jucm_OneFileWorkaround.ucm.map.MapPackage#getStub_RepetitionCount()
	 * @model default="1"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link jucm_OneFileWorkaround.ucm.map.Stub#getRepetitionCount <em>Repetition Count</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see jucm_OneFileWorkaround.ucm.map.MapPackage#getStub_Pointcut()
	 * @model default="false"
	 * @generated
	 */
	boolean isPointcut();
	...
	/**
	 * Sets the value of the '{@link jucm_OneFileWorkaround.ucm.map.Stub#isPointcut <em>Pointcut</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see jucm_OneFileWorkaround.ucm.map.MapPackage#getStub_Synchronization()
	 * @model default="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link jucm_OneFileWorkaround.ucm.map.Stub#isSynchronization <em>Synchronization</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see jucm_OneFileWorkaround.ucm.map.MapPackage#getStub_Blocking()
	 * @model default="false"
	 * @generated
	 */
	boolean isBlocking();
	...
	/**
	 * Sets the value of the '{@link jucm_OneFileWorkaround.ucm.map.Stub#isBlocking <em>Blocking</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link jucm_OneFileWorkaround.ucm.map.PointcutKind}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see jucm_OneFileWorkaround.ucm.map.MapPackage#getStub_Aopointcut()
	 * @model default="None"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link jucm_OneFileWorkaround.ucm.map.Stub#getAopointcut <em>Aopointcut</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The default value is <code>"None"</code>.
	 * The literals are from the enumeration {@link jucm_OneFileWorkaround.ucm.map.AspectKind}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see jucm_OneFileWorkaround.ucm.map.MapPackage#getStub_Aspect()
	 * @model default="None"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link jucm_OneFileWorkaround.ucm.map.Stub#getAspect <em>Aspect</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link jucm_OneFileWorkaround.ucm.map.PluginBinding#getStub <em>Stub</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see jucm_OneFileWorkaround.ucm.map.MapPackage#getStub_Bindings()
