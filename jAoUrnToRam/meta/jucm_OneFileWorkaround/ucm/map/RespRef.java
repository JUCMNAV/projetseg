 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.RespRef#getRepetitionCount <em>Repetition Count</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.RespRef#getHostDemand <em>Host Demand</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.RespRef#getRespDef <em>Resp Def</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.RespRef#getPluginBindings <em>Plugin Bindings</em>}</li>
 * </ul>
 * </p>
 *
 * @see jucm_OneFileWorkaround.ucm.map.MapPackage#getRespRef()
 * @model
 * @generated
 */
public interface RespRef extends PathNode {
	intermediateWorkflow.IwCustomizableNode getIwCustomizableNode();
	//Metadata getRamMetadata();
	void buildCustomizableNode();
	boolean isSystem();
	 ...
	 * @see jucm_OneFileWorkaround.ucm.map.MapPackage#getRespRef_RepetitionCount()
	 * @model default="1"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link jucm_OneFileWorkaround.ucm.map.RespRef#getRepetitionCount <em>Repetition Count</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see jucm_OneFileWorkaround.ucm.map.MapPackage#getRespRef_HostDemand()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link jucm_OneFileWorkaround.ucm.map.RespRef#getHostDemand <em>Host Demand</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link jucm_OneFileWorkaround.urncore.Responsibility#getRespRefs <em>Resp Refs</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see jucm_OneFileWorkaround.ucm.map.MapPackage#getRespRef_RespDef()
	...
	/**
	 * Sets the value of the '{@link jucm_OneFileWorkaround.ucm.map.RespRef#getRespDef <em>Resp Def</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link jucm_OneFileWorkaround.ucm.map.ResponsibilityBinding#getPluginResp <em>Plugin Resp</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see jucm_OneFileWorkaround.ucm.map.MapPackage#getRespRef_PluginBindings()
	 * @see jucm_OneFileWorkaround.ucm.map.ResponsibilityBinding#getPluginResp
	 * @model opposite="pluginResp"
	 * @generated
	 */
	EList<ResponsibilityBinding> getPluginBindings();
