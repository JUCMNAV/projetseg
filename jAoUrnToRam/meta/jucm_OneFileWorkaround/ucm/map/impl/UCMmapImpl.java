 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.UCMmapImpl#getUrndefinition <em>Urndefinition</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.UCMmapImpl#getNodes <em>Nodes</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.UCMmapImpl#getContRefs <em>Cont Refs</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.UCMmapImpl#getConnections <em>Connections</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.UCMmapImpl#getConcern <em>Concern</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.UCMmapImpl#getComments <em>Comments</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.UCMmapImpl#isSingleton <em>Singleton</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.UCMmapImpl#getParentStub <em>Parent Stub</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
