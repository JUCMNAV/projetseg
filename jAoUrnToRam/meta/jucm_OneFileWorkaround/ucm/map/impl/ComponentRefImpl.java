...
import jucm_OneFileWorkaround.ucm.map.ComponentBinding;
import jucm_OneFileWorkaround.ucm.map.ComponentRef;
import jucm_OneFileWorkaround.ucm.map.MapPackage;

import jucm_OneFileWorkaround.urncore.ComponentLabel;
 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.ComponentRefImpl#getX <em>X</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.ComponentRefImpl#getY <em>Y</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.ComponentRefImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.ComponentRefImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.ComponentRefImpl#isFixed <em>Fixed</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.ComponentRefImpl#getDiagram <em>Diagram</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.ComponentRefImpl#getContDef <em>Cont Def</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.ComponentRefImpl#getNodes <em>Nodes</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.ComponentRefImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.ComponentRefImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.ComponentRefImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.ComponentRefImpl#getRole <em>Role</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.ComponentRefImpl#getReplicationFactor <em>Replication Factor</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.ComponentRefImpl#isAnchored <em>Anchored</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.ComponentRefImpl#getParentBindings <em>Parent Bindings</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.ComponentRefImpl#getPluginBindings <em>Plugin Bindings</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComponentRefImpl extends UCMmodelElementImpl implements ComponentRef {
	 ...
	 * @ordered
	 */
	protected EList<IURNContainerRef> children;
	 ...
	 * @ordered
	 */
	protected EList<ComponentBinding> parentBindings;
	 ...
	 * @ordered
	 */
	protected EList<ComponentBinding> pluginBindings;
	...
	public EList<IURNNode> getNodes() {
		if (nodes == null) {
			nodes = new EObjectWithInverseResolvingEList<IURNNode>(IURNNode.class, this, MapPackage.COMPONENT_REF__NODES, UrncorePackage.IURN_NODE__CONT_REF);
		}
		return nodes;
	}
	 ...
	 * @generated
	 */
	public EList<IURNContainerRef> getChildren() {
		if (children == null) {
			children = new EObjectWithInverseResolvingEList<IURNContainerRef>(IURNContainerRef.class, this, MapPackage.COMPONENT_REF__CHILDREN, UrncorePackage.IURN_CONTAINER_REF__PARENT);
		}
		return children;
	}
	 ...
	 * @generated
	 */
	public EList<ComponentBinding> getParentBindings() {
		if (parentBindings == null) {
			parentBindings = new EObjectWithInverseResolvingEList<ComponentBinding>(ComponentBinding.class, this, MapPackage.COMPONENT_REF__PARENT_BINDINGS, MapPackage.COMPONENT_BINDING__PARENT_COMPONENT);
		}
	 ...
	 * @generated
	 */
	public EList<ComponentBinding> getPluginBindings() {
		if (pluginBindings == null) {
			pluginBindings = new EObjectWithInverseResolvingEList<ComponentBinding>(ComponentBinding.class, this, MapPackage.COMPONENT_REF__PLUGIN_BINDINGS, MapPackage.COMPONENT_BINDING__PLUGIN_COMPONENT);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case MapPackage.COMPONENT_REF__PARENT_BINDINGS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getParentBindings()).basicAdd(otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MapPackage.COMPONENT_REF__CHILDREN:
				getChildren().clear();
				getChildren().addAll((Collection<? extends IURNContainerRef>)newValue);
				return;
			case MapPackage.COMPONENT_REF__ROLE:
			...
			case MapPackage.COMPONENT_REF__REPLICATION_FACTOR:
				...
				return;
			case MapPackage.COMPONENT_REF__ANCHORED:
				setAnchored((Boolean)newValue);
				return;
			case MapPackage.COMPONENT_REF__PARENT_BINDINGS:
				getParentBindings().clear();
				getParentBindings().addAll((Collection<? extends ComponentBinding>)newValue);
				return;
			case MapPackage.COMPONENT_REF__PLUGIN_BINDINGS:
				getPluginBindings().clear();
				getPluginBindings().addAll((Collection<? extends ComponentBinding>)newValue);
				return;
		}
