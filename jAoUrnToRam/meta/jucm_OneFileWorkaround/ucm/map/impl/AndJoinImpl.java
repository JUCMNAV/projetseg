 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.AndJoinImpl#getOrientation <em>Orientation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AndJoinImpl extends PathNodeImpl implements AndJoin {
	/*private IwAndJoin iwAndJoin;
	
	@Override
	public IwAndJoin getIwAndJoin(){
		return iwAndJoin;
	};*/
	
	@Override
	public void buildIwNodeTemplate() {
		IwAndJoin iwAndJoin = IntermediateWorkflowFactory.eINSTANCE.createIwAndJoin();
		iwAndJoin.setName(nameOrPrefixId("AndJoin"));
