...
import jucm_OneFileWorkaround.ucm.map.Connect;
...
import jucm_OneFileWorkaround.ucm.map.PathNode;
import jucm_OneFileWorkaround.ucm.map.UCMmap;

import jucm_OneFileWorkaround.urncore.Condition;
import jucm_OneFileWorkaround.urncore.ConnectionLabel;
 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.NodeConnectionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.NodeConnectionImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.NodeConnectionImpl#getDiagram <em>Diagram</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.NodeConnectionImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.NodeConnectionImpl#getProbability <em>Probability</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.NodeConnectionImpl#getThreshold <em>Threshold</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.NodeConnectionImpl#getInBindings <em>In Bindings</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.NodeConnectionImpl#getOutBindings <em>Out Bindings</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.NodeConnectionImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.NodeConnectionImpl#getOutBindingsPlugin <em>Out Bindings Plugin</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.NodeConnectionImpl#getInBindingsPlugin <em>In Bindings Plugin</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NodeConnectionImpl extends EObjectImpl implements NodeConnection {
	private IwNodeConnection iwNodeConnection;
	...
	@Override
	public IwNodeConnection getIwNodeConnection() {
		return iwNodeConnection;
	}

	@Override
	public IwNode iwSingleTarget() {
		if(targetAsPathNode().iwHasNodes()) 
			return targetAsPathNode().iwGetEntryNode(this);
		else {
			return iwNextNodeConnection().iwSingleTarget();
		}
	}

	@Override
	public void initStubEntryIndex(Integer stubEntryIndex) {
		for(IwNodeConnection iwNodeConnection : iwDisjunctivePredNodeConnections())
			iwNodeConnection.setStubEntryIndexAsString(stubEntryIndex.toString());
	}

	@Override
	public LinkedHashSet<IwNodeConnection> iwDisjunctivePredNodeConnections() {
		LinkedHashSet<IwNodeConnection> nodeConnections = new LinkedHashSet<IwNodeConnection>();
		iwDisjunctivePredNodeConnections_Recurse(nodeConnections);
		return nodeConnections;	
	}

	@Override
	public void iwDisjunctivePredNodeConnections_Recurse(LinkedHashSet<IwNodeConnection> disjunctivePredNodeConnections) {
		if(iwNodeConnection != null) 
			...
			for(NodeConnection nodeConnection : sourceAsPathNode().predAsNodeConnection())
	...
	@Override
	public PathNode sourceAsPathNode() {
		return (PathNode)source;
	}

	@Override
	public UCMmap ucmMap() {
		return sourceAsPathNode().getUCMmap();
	}
