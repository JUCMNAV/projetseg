 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.EndPointImpl#isLocal <em>Local</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.EndPointImpl#getOutBindings <em>Out Bindings</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.EndPointImpl#getPostcondition <em>Postcondition</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.EndPointImpl#getScenarioEndPoints <em>Scenario End Points</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EndPointImpl extends PathNodeImpl implements EndPoint {
	private IwEndPoint iwEndPoint;
	
	@Override
	public IwEndPoint getIwEndPoint(){
		return iwEndPoint;
	};
	
	@Override
	public void buildIwNodeTemplate() {
		iwEndPoint = IntermediateWorkflowFactory.eINSTANCE.createIwEndPoint();
		iwEndPoint.setName(nameOrPrefixId("EndPoint"));
	 ...
	 * @ordered
	 */
	protected EList<ScenarioEndPoint> scenarioEndPoints;
	...
	public EList<OutBinding> getOutBindings() {
		if (outBindings == null) {
			outBindings = new EObjectWithInverseResolvingEList<OutBinding>(OutBinding.class, this, MapPackage.END_POINT__OUT_BINDINGS, MapPackage.OUT_BINDING__END_POINT);
		}
		return outBindings;
	}
	 ...
	 * @generated
	 */
	public EList<ScenarioEndPoint> getScenarioEndPoints() {
		if (scenarioEndPoints == null) {
			scenarioEndPoints = new EObjectWithInverseResolvingEList<ScenarioEndPoint>(ScenarioEndPoint.class, this, MapPackage.END_POINT__SCENARIO_END_POINTS, ScenarioPackage.SCENARIO_END_POINT__END_POINT);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case MapPackage.END_POINT__SCENARIO_END_POINTS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getScenarioEndPoints()).basicAdd(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MapPackage.END_POINT__SCENARIO_END_POINTS:
				...
				getScenarioEndPoints().addAll((Collection<? extends ScenarioEndPoint>)newValue);
				return;
		}
