...
import jucm_OneFileWorkaround.ucm.map.InBinding;
import jucm_OneFileWorkaround.ucm.map.MapPackage;
import jucm_OneFileWorkaround.ucm.map.OutBinding;
 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.PluginBindingImpl#getId <em>Id</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.PluginBindingImpl#getProbability <em>Probability</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.PluginBindingImpl#isTransaction <em>Transaction</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.PluginBindingImpl#getReplicationFactor <em>Replication Factor</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.PluginBindingImpl#getIn <em>In</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.PluginBindingImpl#getOut <em>Out</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.PluginBindingImpl#getStub <em>Stub</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.PluginBindingImpl#getPlugin <em>Plugin</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.PluginBindingImpl#getPrecondition <em>Precondition</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.PluginBindingImpl#getComponents <em>Components</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.PluginBindingImpl#getResponsibilities <em>Responsibilities</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PluginBindingImpl extends EObjectImpl implements PluginBinding {
	private IwPluginBinding iwPluginBinding;
	@Override
	public void build() {
		iwPluginBinding = IntermediateWorkflowFactory.eINSTANCE.createIwPluginBinding();
			
		for(InBinding inBinding : getIn())
			inBinding.build();
	...
	@Override
	public IwPluginBinding getIwPluginBinding() {
		return iwPluginBinding;
	}

	@Override
	public void linkStub() {
		getStub().addIwPluginBinding(iwPluginBinding);
	}

	@Override
	public void addIwInBinding(IwInBinding iwInBinding) {
		iwPluginBinding.getInBindings().add(iwInBinding);
	}

	@Override
	public void addIwOutBinding(IwOutBinding iwOutBinding) {
		iwPluginBinding.getOutBindings().add(iwOutBinding);
	}
	 ...
	 * @ordered
	 */
	protected EList<ResponsibilityBinding> responsibilities;
	...
	public EList<InBinding> getIn() {
		if (in == null) {
			in = new EObjectContainmentWithInverseEList<InBinding>(InBinding.class, this, MapPackage.PLUGIN_BINDING__IN, MapPackage.IN_BINDING__BINDING);
		}
		return in;
	}
	...
	public EList<OutBinding> getOut() {
		if (out == null) {
			out = new EObjectContainmentWithInverseEList<OutBinding>(OutBinding.class, this, MapPackage.PLUGIN_BINDING__OUT, MapPackage.OUT_BINDING__BINDING);
		}
		return out;
	}
	...
	public EList<ComponentBinding> getComponents() {
		if (components == null) {
			components = new EObjectContainmentWithInverseEList<ComponentBinding>(ComponentBinding.class, this, MapPackage.PLUGIN_BINDING__COMPONENTS, MapPackage.COMPONENT_BINDING__BINDING);
		}
		return components;
	}
	 ...
	 * @generated
	 */
	public EList<ResponsibilityBinding> getResponsibilities() {
		if (responsibilities == null) {
			responsibilities = new EObjectContainmentWithInverseEList<ResponsibilityBinding>(ResponsibilityBinding.class, this, MapPackage.PLUGIN_BINDING__RESPONSIBILITIES, MapPackage.RESPONSIBILITY_BINDING__BINDING);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MapPackage.PLUGIN_BINDING__RESPONSIBILITIES:
				...
				getResponsibilities().addAll((Collection<? extends ResponsibilityBinding>)newValue);
				return;
		}
