...
import jucm_OneFileWorkaround.grl.impl.GrlPackageImpl;

import jucm_OneFileWorkaround.grl.kpimodel.KpimodelPackage;

import jucm_OneFileWorkaround.grl.kpimodel.impl.KpimodelPackageImpl;

import jucm_OneFileWorkaround.ucm.UcmPackage;

import jucm_OneFileWorkaround.ucm.impl.UcmPackageImpl;

import jucm_OneFileWorkaround.ucm.map.AndFork;
import jucm_OneFileWorkaround.ucm.map.AndJoin;
import jucm_OneFileWorkaround.ucm.map.Anything;
...
import jucm_OneFileWorkaround.ucm.map.DirectionArrow;
import jucm_OneFileWorkaround.ucm.map.EmptyPoint;
import jucm_OneFileWorkaround.ucm.map.EndPoint;
import jucm_OneFileWorkaround.ucm.map.FailureKind;
import jucm_OneFileWorkaround.ucm.map.FailurePoint;
import jucm_OneFileWorkaround.ucm.map.InBinding;
import jucm_OneFileWorkaround.ucm.map.MapFactory;
import jucm_OneFileWorkaround.ucm.map.MapPackage;
import jucm_OneFileWorkaround.ucm.map.NodeConnection;
import jucm_OneFileWorkaround.ucm.map.OrFork;
import jucm_OneFileWorkaround.ucm.map.OrJoin;
...
import jucm_OneFileWorkaround.ucm.map.PointcutKind;
...
import jucm_OneFileWorkaround.ucm.map.Timer;
...
import jucm_OneFileWorkaround.ucm.performance.impl.PerformancePackageImpl;

import jucm_OneFileWorkaround.ucm.scenario.ScenarioPackage;

import jucm_OneFileWorkaround.ucm.scenario.impl.ScenarioPackageImpl;

import jucm_OneFileWorkaround.urn.UrnPackage;

import jucm_OneFileWorkaround.urn.impl.UrnPackageImpl;

import jucm_OneFileWorkaround.urncore.UrncorePackage;

import jucm_OneFileWorkaround.urncore.impl.UrncorePackageImpl;
...
public class MapPackageImpl extends EPackageImpl implements MapPackage {
	 ...
	 * @see jucm_OneFileWorkaround.ucm.map.MapPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		addEEnumLiteral(aspectKindEEnum, AspectKind.NONE);
		addEEnumLiteral(aspectKindEEnum, AspectKind.REGULAR);
		addEEnumLiteral(aspectKindEEnum, AspectKind.ENTRANCE);
		addEEnumLiteral(aspectKindEEnum, AspectKind.EXIT);
		addEEnumLiteral(aspectKindEEnum, AspectKind.CONDITIONAL);

		initEEnum(pointcutKindEEnum, PointcutKind.class, "PointcutKind");
		addEEnumLiteral(pointcutKindEEnum, PointcutKind.NONE);
		addEEnumLiteral(pointcutKindEEnum, PointcutKind.REGULAR);
		addEEnumLiteral(pointcutKindEEnum, PointcutKind.REPLACEMENT);

		initEEnum(failureKindEEnum, FailureKind.class, "FailureKind");
		addEEnumLiteral(failureKindEEnum, FailureKind.FAILURE);
		addEEnumLiteral(failureKindEEnum, FailureKind.ABORT);
		addEEnumLiteral(failureKindEEnum, FailureKind.NONE);
	}
