 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.OrForkImpl#getOrientation <em>Orientation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrForkImpl extends PathNodeImpl implements OrFork {
	/*private IwOrFork iwOrFork;
	
	@Override
	public IwOrFork getIwOrFork(){
		return iwOrFork;
	};*/
	
	@Override
	public void buildIwNodeTemplate() {
		IwOrFork iwOrFork = IntermediateWorkflowFactory.eINSTANCE.createIwOrFork();
		iwOrFork.setName(nameOrPrefixId("OrFork"));
