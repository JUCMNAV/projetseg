 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.OutBindingImpl#getBinding <em>Binding</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.OutBindingImpl#getEndPoint <em>End Point</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.OutBindingImpl#getStubExit <em>Stub Exit</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.OutBindingImpl#getPointcutEntry <em>Pointcut Entry</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OutBindingImpl extends EObjectImpl implements OutBinding {
	private IwOutBinding iwOutBinding;
	@Override
	public void build() {
		iwOutBinding = IntermediateWorkflowFactory.eINSTANCE.createIwOutBinding();
	}
	...
	@Override
	public IwOutBinding getIwOutBinding() {
		return iwOutBinding;
	}

	@Override
	public void linkPluginBinding() {
		getBinding().addIwOutBinding(iwOutBinding);	
	}

	@Override
	public void linkStubExit() {
		iwOutBinding.setStubExit(getStubExit().getIwNodeConnection());
	}

	@Override
	public void linkEndPoint() {
		//pointcutEntry.isVoid
		if(getPointcutEntry() == null) 
			iwOutBinding.setPluginEndPoint(getEndPoint().getIwEndPoint());
		else
			iwOutBinding.setPluginEndPoint(iwGetPluginEndPointFromPointcutStub());
	}

	@Override
	public IwEndPoint iwGetPluginEndPointFromPointcutStub() {
		PathNode pointcutStub = getPointcutEntry().targetAsPathNode();
		return (IwEndPoint)pointcutStub.iwGetEntryNode(getPointcutEntry());
	}
