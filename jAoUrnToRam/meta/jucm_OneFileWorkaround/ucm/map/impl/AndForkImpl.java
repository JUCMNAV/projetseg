 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.AndForkImpl#getOrientation <em>Orientation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AndForkImpl extends PathNodeImpl implements AndFork {
	//private IwAndFork iwAndFork;
	
	/*@Override
	public IwAndFork getIwAndFork(){
		return iwAndFork;
	};*/
	
	@Override
	public void buildIwNodeTemplate() {
		IwAndFork iwAndFork = IntermediateWorkflowFactory.eINSTANCE.createIwAndFork();
		iwAndFork.setName(nameOrPrefixId("AndFork"));
