 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.PathNodeImpl#getX <em>X</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.PathNodeImpl#getY <em>Y</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.PathNodeImpl#getDiagram <em>Diagram</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.PathNodeImpl#getContRef <em>Cont Ref</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.PathNodeImpl#getSucc <em>Succ</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.PathNodeImpl#getPred <em>Pred</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.map.impl.PathNodeImpl#getLabel <em>Label</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
