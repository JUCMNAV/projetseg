 ...
 * $Id$
 */
package jucm_OneFileWorkaround.ucm.impl;
 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.ucm.impl.UCMspecImpl#getUrnspec <em>Urnspec</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.impl.UCMspecImpl#getResources <em>Resources</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.impl.UCMspecImpl#getScenarioGroups <em>Scenario Groups</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.impl.UCMspecImpl#getVariables <em>Variables</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.ucm.impl.UCMspecImpl#getEnumerationTypes <em>Enumeration Types</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UCMspecImpl extends EObjectImpl implements UCMspec {
	...
	public EList<GeneralResource> getResources() {
		if (resources == null) {
			resources = new EObjectContainmentWithInverseEList<GeneralResource>(GeneralResource.class, this, UcmPackage.UC_MSPEC__RESOURCES, PerformancePackage.GENERAL_RESOURCE__UCMSPEC);
		}
		return resources;
	}
	...
	public EList<ScenarioGroup> getScenarioGroups() {
		if (scenarioGroups == null) {
			scenarioGroups = new EObjectContainmentWithInverseEList<ScenarioGroup>(ScenarioGroup.class, this, UcmPackage.UC_MSPEC__SCENARIO_GROUPS, ScenarioPackage.SCENARIO_GROUP__UCMSPEC);
		}
	...
	public EList<Variable> getVariables() {
		if (variables == null) {
			variables = new EObjectContainmentWithInverseEList<Variable>(Variable.class, this, UcmPackage.UC_MSPEC__VARIABLES, ScenarioPackage.VARIABLE__UCMSPEC);
		}
		return variables;
	}
	...
	public EList<EnumerationType> getEnumerationTypes() {
		if (enumerationTypes == null) {
			enumerationTypes = new EObjectContainmentWithInverseEList<EnumerationType>(EnumerationType.class, this, UcmPackage.UC_MSPEC__ENUMERATION_TYPES, ScenarioPackage.ENUMERATION_TYPE__UCMSPEC);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case UcmPackage.UC_MSPEC__SCENARIO_GROUPS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getScenarioGroups()).basicAdd(otherEnd, msgs);
			...
			case UcmPackage.UC_MSPEC__ENUMERATION_TYPES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getEnumerationTypes()).basicAdd(otherEnd, msgs);
		}
