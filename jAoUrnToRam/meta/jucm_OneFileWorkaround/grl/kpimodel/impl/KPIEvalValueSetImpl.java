 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.impl.KPIEvalValueSetImpl#getTargetValue <em>Target Value</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.impl.KPIEvalValueSetImpl#getThresholdValue <em>Threshold Value</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.impl.KPIEvalValueSetImpl#getWorstValue <em>Worst Value</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.impl.KPIEvalValueSetImpl#getEvaluationValue <em>Evaluation Value</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.impl.KPIEvalValueSetImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.impl.KPIEvalValueSetImpl#getQualitativeEvaluationValue <em>Qualitative Evaluation Value</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.impl.KPIEvalValueSetImpl#getEval <em>Eval</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.impl.KPIEvalValueSetImpl#getKpiConv <em>Kpi Conv</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
