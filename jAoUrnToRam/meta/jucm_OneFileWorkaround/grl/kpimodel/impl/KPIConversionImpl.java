 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.impl.KPIConversionImpl#getKpiEvalValueSet <em>Kpi Eval Value Set</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.impl.KPIConversionImpl#getGrlspec <em>Grlspec</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class KPIConversionImpl extends GRLmodelElementImpl implements KPIConversion {
	...
	public EList<KPIEvalValueSet> getKpiEvalValueSet() {
		if (kpiEvalValueSet == null) {
			kpiEvalValueSet = new EObjectWithInverseResolvingEList<KPIEvalValueSet>(KPIEvalValueSet.class, this, KpimodelPackage.KPI_CONVERSION__KPI_EVAL_VALUE_SET, KpimodelPackage.KPI_EVAL_VALUE_SET__KPI_CONV);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case KpimodelPackage.KPI_CONVERSION__KPI_EVAL_VALUE_SET:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getKpiEvalValueSet()).basicAdd(otherEnd, msgs);
