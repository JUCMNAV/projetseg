 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.impl.IndicatorGroupImpl#isIsRedesignCategory <em>Is Redesign Category</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.impl.IndicatorGroupImpl#getGrlspec <em>Grlspec</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.impl.IndicatorGroupImpl#getIndicators <em>Indicators</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IndicatorGroupImpl extends GRLmodelElementImpl implements IndicatorGroup {
	...
	public EList<Indicator> getIndicators() {
		if (indicators == null) {
			indicators = new EObjectWithInverseResolvingEList.ManyInverse<Indicator>(Indicator.class, this, KpimodelPackage.INDICATOR_GROUP__INDICATORS, KpimodelPackage.INDICATOR__GROUPS);
		}
		return indicators;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case KpimodelPackage.INDICATOR_GROUP__INDICATORS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getIndicators()).basicAdd(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case KpimodelPackage.INDICATOR_GROUP__IS_REDESIGN_CATEGORY:
				setIsRedesignCategory((Boolean)newValue);
				return;
			case KpimodelPackage.INDICATOR_GROUP__GRLSPEC:
