 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.impl.KPIModelLinkImpl#getKpiInformationElementSrc <em>Kpi Information Element Src</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.impl.KPIModelLinkImpl#getRefs <em>Refs</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.impl.KPIModelLinkImpl#getGrlspec <em>Grlspec</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.impl.KPIModelLinkImpl#getIndDest <em>Ind Dest</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class KPIModelLinkImpl extends GRLmodelElementImpl implements KPIModelLink {
	 ...
	 * @ordered
	 */
	protected EList<KPIModelLinkRef> refs;
	 ...
	 * @generated
	 */
	public EList<KPIModelLinkRef> getRefs() {
		if (refs == null) {
			refs = new EObjectWithInverseResolvingEList<KPIModelLinkRef>(KPIModelLinkRef.class, this, KpimodelPackage.KPI_MODEL_LINK__REFS, KpimodelPackage.KPI_MODEL_LINK_REF__LINK);
		}
		return refs;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case KpimodelPackage.KPI_MODEL_LINK__REFS:
				getRefs().clear();
				getRefs().addAll((Collection<? extends KPIModelLinkRef>)newValue);
				return;
			case KpimodelPackage.KPI_MODEL_LINK__GRLSPEC:
