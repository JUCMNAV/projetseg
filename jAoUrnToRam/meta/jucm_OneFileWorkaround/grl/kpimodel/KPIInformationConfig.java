 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.KPIInformationConfig#getLevelOfDimension <em>Level Of Dimension</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.KPIInformationConfig#getValueOfDimension <em>Value Of Dimension</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.KPIInformationConfig#getStrategies <em>Strategies</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.kpimodel.KPIInformationConfig#getKpiInfoElement <em>Kpi Info Element</em>}</li>
 * </ul>
 * </p>
 *
 * @see jucm_OneFileWorkaround.grl.kpimodel.KpimodelPackage#getKPIInformationConfig()
 * @model
 * @generated
 */
public interface KPIInformationConfig extends EObject {
	 ...
	 * @see jucm_OneFileWorkaround.grl.kpimodel.KpimodelPackage#getKPIInformationConfig_LevelOfDimension()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link jucm_OneFileWorkaround.grl.kpimodel.KPIInformationConfig#getLevelOfDimension <em>Level Of Dimension</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see jucm_OneFileWorkaround.grl.kpimodel.KpimodelPackage#getKPIInformationConfig_ValueOfDimension()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link jucm_OneFileWorkaround.grl.kpimodel.KPIInformationConfig#getValueOfDimension <em>Value Of Dimension</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link jucm_OneFileWorkaround.grl.EvaluationStrategy#getKpiInfoConfig <em>Kpi Info Config</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see jucm_OneFileWorkaround.grl.kpimodel.KpimodelPackage#getKPIInformationConfig_Strategies()
	...
	/**
	 * Sets the value of the '{@link jucm_OneFileWorkaround.grl.kpimodel.KPIInformationConfig#getStrategies <em>Strategies</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see jucm_OneFileWorkaround.grl.kpimodel.KpimodelPackage#getKPIInformationConfig_KpiInfoElement()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link jucm_OneFileWorkaround.grl.kpimodel.KPIInformationConfig#getKpiInfoElement <em>Kpi Info Element</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
