 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ElementLinkImpl#getRefs <em>Refs</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ElementLinkImpl#getGrlspec <em>Grlspec</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ElementLinkImpl#getDest <em>Dest</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ElementLinkImpl#getSrc <em>Src</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ElementLinkImpl extends GRLmodelElementImpl implements ElementLink {
	 ...
	 * @generated
	 */
	public EList<LinkRef> getRefs() {
		if (refs == null) {
			refs = new EObjectWithInverseResolvingEList<LinkRef>(LinkRef.class, this, GrlPackage.ELEMENT_LINK__REFS, GrlPackage.LINK_REF__LINK);
		}
		return refs;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case GrlPackage.ELEMENT_LINK__REFS:
				getRefs().clear();
				getRefs().addAll((Collection<? extends LinkRef>)newValue);
				return;
			case GrlPackage.ELEMENT_LINK__GRLSPEC:
