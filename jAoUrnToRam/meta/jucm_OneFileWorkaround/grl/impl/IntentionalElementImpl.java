 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.IntentionalElementImpl#getType <em>Type</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.IntentionalElementImpl#getDecompositionType <em>Decomposition Type</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.IntentionalElementImpl#getImportance <em>Importance</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.IntentionalElementImpl#getImportanceQuantitative <em>Importance Quantitative</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.IntentionalElementImpl#getLineColor <em>Line Color</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.IntentionalElementImpl#getFillColor <em>Fill Color</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.IntentionalElementImpl#isFilled <em>Filled</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.IntentionalElementImpl#getGrlspec <em>Grlspec</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.IntentionalElementImpl#getRefs <em>Refs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntentionalElementImpl extends GRLLinkableElementImpl implements IntentionalElement {
	...
	public EList<IntentionalElementRef> getRefs() {
		if (refs == null) {
			refs = new EObjectWithInverseResolvingEList<IntentionalElementRef>(IntentionalElementRef.class, this, GrlPackage.INTENTIONAL_ELEMENT__REFS, GrlPackage.INTENTIONAL_ELEMENT_REF__DEF);
		}
		return refs;
	}
