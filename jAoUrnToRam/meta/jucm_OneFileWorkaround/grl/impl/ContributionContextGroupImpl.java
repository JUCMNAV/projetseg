 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ContributionContextGroupImpl#getGrlspec <em>Grlspec</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ContributionContextGroupImpl#getContribs <em>Contribs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContributionContextGroupImpl extends GRLmodelElementImpl implements ContributionContextGroup {
	...
	public EList<ContributionContext> getContribs() {
		if (contribs == null) {
			contribs = new EObjectWithInverseResolvingEList.ManyInverse<ContributionContext>(ContributionContext.class, this, GrlPackage.CONTRIBUTION_CONTEXT_GROUP__CONTRIBS, GrlPackage.CONTRIBUTION_CONTEXT__GROUPS);
		}
		return contribs;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case GrlPackage.CONTRIBUTION_CONTEXT_GROUP__CONTRIBS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getContribs()).basicAdd(otherEnd, msgs);
		}
