 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.EvaluationImpl#getEvaluation <em>Evaluation</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.EvaluationImpl#getQualitativeEvaluation <em>Qualitative Evaluation</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.EvaluationImpl#isExceeds <em>Exceeds</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.EvaluationImpl#getIntElement <em>Int Element</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.EvaluationImpl#getStrategies <em>Strategies</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.EvaluationImpl#getKpiEvalValueSet <em>Kpi Eval Value Set</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.EvaluationImpl#getEvalRange <em>Eval Range</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.EvaluationImpl#getKpiNewEvalValue <em>Kpi New Eval Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
