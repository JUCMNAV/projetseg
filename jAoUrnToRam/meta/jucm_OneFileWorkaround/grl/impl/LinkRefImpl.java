 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.LinkRefImpl#getSource <em>Source</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.LinkRefImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.LinkRefImpl#getDiagram <em>Diagram</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.LinkRefImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.LinkRefImpl#getLink <em>Link</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.LinkRefImpl#getBendpoints <em>Bendpoints</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LinkRefImpl extends EObjectImpl implements LinkRef {
	...
	public EList<LinkRefBendpoint> getBendpoints() {
		if (bendpoints == null) {
			bendpoints = new EObjectContainmentWithInverseEList<LinkRefBendpoint>(LinkRefBendpoint.class, this, GrlPackage.LINK_REF__BENDPOINTS, GrlPackage.LINK_REF_BENDPOINT__LINKREF);
		}
		return bendpoints;
	}
