 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.StrategiesGroupImpl#getStrategies <em>Strategies</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.StrategiesGroupImpl#getGrlspec <em>Grlspec</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StrategiesGroupImpl extends GRLmodelElementImpl implements StrategiesGroup {
	...
	public EList<EvaluationStrategy> getStrategies() {
		if (strategies == null) {
			strategies = new EObjectWithInverseResolvingEList<EvaluationStrategy>(EvaluationStrategy.class, this, GrlPackage.STRATEGIES_GROUP__STRATEGIES, GrlPackage.EVALUATION_STRATEGY__GROUP);
		}
		return strategies;
	}
