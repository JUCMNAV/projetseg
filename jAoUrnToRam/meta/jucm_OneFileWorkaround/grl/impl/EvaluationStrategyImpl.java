...
import jucm_OneFileWorkaround.urncore.impl.GRLmodelElementImpl;
 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.EvaluationStrategyImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.EvaluationStrategyImpl#getEvaluations <em>Evaluations</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.EvaluationStrategyImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.EvaluationStrategyImpl#getGrlspec <em>Grlspec</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.EvaluationStrategyImpl#getIncludedStrategies <em>Included Strategies</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.EvaluationStrategyImpl#getParentStrategies <em>Parent Strategies</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.EvaluationStrategyImpl#getKpiInfoConfig <em>Kpi Info Config</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EvaluationStrategyImpl extends GRLmodelElementImpl implements EvaluationStrategy {
	 ...
	 * @ordered
	 */
	protected EList<EvaluationStrategy> parentStrategies;
	 ...
	 * @ordered
	 */
	protected EList<KPIInformationConfig> kpiInfoConfig;
	...
	public EList<Evaluation> getEvaluations() {
		if (evaluations == null) {
			evaluations = new EObjectContainmentWithInverseEList<Evaluation>(Evaluation.class, this, GrlPackage.EVALUATION_STRATEGY__EVALUATIONS, GrlPackage.EVALUATION__STRATEGIES);
		}
		return evaluations;
	}
	...
	public EList<EvaluationStrategy> getIncludedStrategies() {
		if (includedStrategies == null) {
			includedStrategies = new EObjectWithInverseResolvingEList.ManyInverse<EvaluationStrategy>(EvaluationStrategy.class, this, GrlPackage.EVALUATION_STRATEGY__INCLUDED_STRATEGIES, GrlPackage.EVALUATION_STRATEGY__PARENT_STRATEGIES);
		}
	 ...
	 * @generated
	 */
	public EList<EvaluationStrategy> getParentStrategies() {
		if (parentStrategies == null) {
			parentStrategies = new EObjectWithInverseResolvingEList.ManyInverse<EvaluationStrategy>(EvaluationStrategy.class, this, GrlPackage.EVALUATION_STRATEGY__PARENT_STRATEGIES, GrlPackage.EVALUATION_STRATEGY__INCLUDED_STRATEGIES);
		}
	 ...
	 * @generated
	 */
	public EList<KPIInformationConfig> getKpiInfoConfig() {
		if (kpiInfoConfig == null) {
			kpiInfoConfig = new EObjectContainmentWithInverseEList<KPIInformationConfig>(KPIInformationConfig.class, this, GrlPackage.EVALUATION_STRATEGY__KPI_INFO_CONFIG, KpimodelPackage.KPI_INFORMATION_CONFIG__STRATEGIES);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case GrlPackage.EVALUATION_STRATEGY__INCLUDED_STRATEGIES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getIncludedStrategies()).basicAdd(otherEnd, msgs);
			case GrlPackage.EVALUATION_STRATEGY__PARENT_STRATEGIES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getParentStrategies()).basicAdd(otherEnd, msgs);
			case GrlPackage.EVALUATION_STRATEGY__KPI_INFO_CONFIG:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getKpiInfoConfig()).basicAdd(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case GrlPackage.EVALUATION_STRATEGY__PARENT_STRATEGIES:
				...
				getParentStrategies().addAll((Collection<? extends EvaluationStrategy>)newValue);
				return;
			case GrlPackage.EVALUATION_STRATEGY__KPI_INFO_CONFIG:
				getKpiInfoConfig().clear();
				getKpiInfoConfig().addAll((Collection<? extends KPIInformationConfig>)newValue);
				return;
		}
