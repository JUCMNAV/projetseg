 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorImpl#getLineColor <em>Line Color</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorImpl#getFillColor <em>Fill Color</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorImpl#isFilled <em>Filled</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorImpl#getContRefs <em>Cont Refs</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorImpl#getImportance <em>Importance</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorImpl#getImportanceQuantitative <em>Importance Quantitative</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorImpl#getGrlspec <em>Grlspec</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorImpl#getIncludedActors <em>Included Actors</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorImpl#getIncludingActor <em>Including Actor</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorImpl#getCollapsedRefs <em>Collapsed Refs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActorImpl extends GRLLinkableElementImpl implements Actor {
	...
	public EList<IURNContainerRef> getContRefs() {
		if (contRefs == null) {
			contRefs = new EObjectWithInverseResolvingEList<IURNContainerRef>(IURNContainerRef.class, this, GrlPackage.ACTOR__CONT_REFS, UrncorePackage.IURN_CONTAINER_REF__CONT_DEF);
		}
		return contRefs;
	}
	...
	public EList<Actor> getIncludedActors() {
		if (includedActors == null) {
			includedActors = new EObjectWithInverseResolvingEList<Actor>(Actor.class, this, GrlPackage.ACTOR__INCLUDED_ACTORS, GrlPackage.ACTOR__INCLUDING_ACTOR);
		}
	...
	public EList<CollapsedActorRef> getCollapsedRefs() {
		if (collapsedRefs == null) {
			collapsedRefs = new EObjectWithInverseResolvingEList<CollapsedActorRef>(CollapsedActorRef.class, this, GrlPackage.ACTOR__COLLAPSED_REFS, GrlPackage.COLLAPSED_ACTOR_REF__ACTOR);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case GrlPackage.ACTOR__INCLUDED_ACTORS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getIncludedActors()).basicAdd(otherEnd, msgs);
			...
			case GrlPackage.ACTOR__COLLAPSED_REFS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getCollapsedRefs()).basicAdd(otherEnd, msgs);
		}
