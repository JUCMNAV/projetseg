 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.GRLNodeImpl#getX <em>X</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.GRLNodeImpl#getY <em>Y</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.GRLNodeImpl#getDiagram <em>Diagram</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.GRLNodeImpl#getContRef <em>Cont Ref</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.GRLNodeImpl#getSucc <em>Succ</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.GRLNodeImpl#getPred <em>Pred</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.GRLNodeImpl#getLabel <em>Label</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
