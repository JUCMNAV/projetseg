 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorRefImpl#getX <em>X</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorRefImpl#getY <em>Y</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorRefImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorRefImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorRefImpl#isFixed <em>Fixed</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorRefImpl#getDiagram <em>Diagram</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorRefImpl#getContDef <em>Cont Def</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorRefImpl#getNodes <em>Nodes</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorRefImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorRefImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.ActorRefImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActorRefImpl extends GRLmodelElementImpl implements ActorRef {
	...
	public EList<IURNNode> getNodes() {
		if (nodes == null) {
			nodes = new EObjectWithInverseResolvingEList<IURNNode>(IURNNode.class, this, GrlPackage.ACTOR_REF__NODES, UrncorePackage.IURN_NODE__CONT_REF);
		}
		return nodes;
	}
	...
	public EList<IURNContainerRef> getChildren() {
		if (children == null) {
			children = new EObjectWithInverseResolvingEList<IURNContainerRef>(IURNContainerRef.class, this, GrlPackage.ACTOR_REF__CHILDREN, UrncorePackage.IURN_CONTAINER_REF__PARENT);
		}
		return children;
	}
