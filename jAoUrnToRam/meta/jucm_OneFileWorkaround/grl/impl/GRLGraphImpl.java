...
import jucm_OneFileWorkaround.urncore.Comment;
 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.GRLGraphImpl#getUrndefinition <em>Urndefinition</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.GRLGraphImpl#getNodes <em>Nodes</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.GRLGraphImpl#getContRefs <em>Cont Refs</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.GRLGraphImpl#getConnections <em>Connections</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.GRLGraphImpl#getConcern <em>Concern</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.grl.impl.GRLGraphImpl#getComments <em>Comments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GRLGraphImpl extends GRLmodelElementImpl implements GRLGraph {
	...
	public EList<IURNNode> getNodes() {
		if (nodes == null) {
			nodes = new EObjectContainmentWithInverseEList<IURNNode>(IURNNode.class, this, GrlPackage.GRL_GRAPH__NODES, UrncorePackage.IURN_NODE__DIAGRAM);
		}
		return nodes;
	}
	...
	public EList<IURNContainerRef> getContRefs() {
		if (contRefs == null) {
			contRefs = new EObjectContainmentWithInverseEList<IURNContainerRef>(IURNContainerRef.class, this, GrlPackage.GRL_GRAPH__CONT_REFS, UrncorePackage.IURN_CONTAINER_REF__DIAGRAM);
		}
		return contRefs;
	}
	...
	public EList<IURNConnection> getConnections() {
		if (connections == null) {
			connections = new EObjectContainmentWithInverseEList<IURNConnection>(IURNConnection.class, this, GrlPackage.GRL_GRAPH__CONNECTIONS, UrncorePackage.IURN_CONNECTION__DIAGRAM);
		}
		return connections;
	}
	...
	public EList<Comment> getComments() {
		if (comments == null) {
			comments = new EObjectContainmentWithInverseEList<Comment>(Comment.class, this, GrlPackage.GRL_GRAPH__COMMENTS, UrncorePackage.COMMENT__DIAGRAM);
		}
		return comments;
	}
