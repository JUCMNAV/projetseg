 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.urn.impl.URNlinkImpl#getType <em>Type</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urn.impl.URNlinkImpl#getUrnspec <em>Urnspec</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urn.impl.URNlinkImpl#getFromElem <em>From Elem</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urn.impl.URNlinkImpl#getToElem <em>To Elem</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urn.impl.URNlinkImpl#getMetadata <em>Metadata</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class URNlinkImpl extends EObjectImpl implements URNlink {
	...
	public EList<Metadata> getMetadata() {
		if (metadata == null) {
			metadata = new EObjectContainmentEList<Metadata>(Metadata.class, this, UrnPackage.UR_NLINK__METADATA);
		}
		return metadata;
	}
