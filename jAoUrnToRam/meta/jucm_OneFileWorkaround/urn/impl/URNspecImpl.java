 ...
 * $Id$
 */
package jucm_OneFileWorkaround.urn.impl;
...
import jucm_OneFileWorkaround.ucm.UcmPackage;
 ...
 * <ul>
 *   <li>{@link jucm_OneFileWorkaround.urn.impl.URNspecImpl#getName <em>Name</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urn.impl.URNspecImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urn.impl.URNspecImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urn.impl.URNspecImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urn.impl.URNspecImpl#getModified <em>Modified</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urn.impl.URNspecImpl#getSpecVersion <em>Spec Version</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urn.impl.URNspecImpl#getUrnVersion <em>Urn Version</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urn.impl.URNspecImpl#getNextGlobalID <em>Next Global ID</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urn.impl.URNspecImpl#getUcmspec <em>Ucmspec</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urn.impl.URNspecImpl#getGrlspec <em>Grlspec</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urn.impl.URNspecImpl#getUrndef <em>Urndef</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urn.impl.URNspecImpl#getUrnLinks <em>Urn Links</em>}</li>
 *   <li>{@link jucm_OneFileWorkaround.urn.impl.URNspecImpl#getMetadata <em>Metadata</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class URNspecImpl extends EObjectImpl implements URNspec {
	IwModel iwModel;
	IwConcern iwWithoutConcern;
	String urnSpecName;
	
	@Override
	public IwModel iwModel() {
		return iwModel;
	}

	@Override
	public IwConcern iwWithoutConcern() {
		return iwWithoutConcern;
	}
	...
	@Override
	public void buildIwModel() {
		iwModel = IntermediateWorkflowFactory.eINSTANCE.createIwModel();
		iwModel.setName(urnSpecName);
	}

	@Override
	public void buildIwWithoutConcern() {
		iwWithoutConcern = IntermediateWorkflowFactory.eINSTANCE.createIwConcern();
		iwWithoutConcern.setName("WithoutConcern");
	}
	...
	@Override
	public void linkConcerns() {
		for(Concern concern : concerns()){
			concern.link();
		}
		if(iwWithoutConcern.getWorkflows().size()>0)
			iwWithoutConcern.setModel(iwModel);	
	}
	
	@Override
	public List<UCMmap> ucmMaps() {
		List<UCMmap> maps = new ArrayList<UCMmap>();
		for(IURNDiagram diagram : getUrndef().getSpecDiagrams()){
			if(diagram instanceof UCMmap){
				maps.add((UCMmap)diagram);
			}
		}
		return maps;
	}
	...
	public List<Concern> concerns() {
		return this.getUrndef().getConcerns();
	}
	/**
	...
	public EList<URNlink> getUrnLinks() {
		if (urnLinks == null) {
			urnLinks = new EObjectContainmentWithInverseEList<URNlink>(URNlink.class, this, UrnPackage.UR_NSPEC__URN_LINKS, UrnPackage.UR_NLINK__URNSPEC);
		}
		return urnLinks;
	}
	...
	public EList<Metadata> getMetadata() {
		if (metadata == null) {
			metadata = new EObjectContainmentEList<Metadata>(Metadata.class, this, UrnPackage.UR_NSPEC__METADATA);
		}
		return metadata;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case UrnPackage.UR_NSPEC__URN_LINKS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getUrnLinks()).basicAdd(otherEnd, msgs);
		}
