package DemoSp5_WithAutDifferentConcern.Instantiators.AuthenticationConcern;
...
public class AuthenticateWorkflowInstantiator extends WorkflowInstantiator{
    ...
    public CustomizableNode _LoginRequest=createCustomizableNode("DemoSp5_WithAutDifferentConcern.Steps.AuthenticationConcern.LoginInfo.LoginRequest");
    public InputNode _LoginInfo=new InputNode();
    public CustomizableNode _PerformAuthentication=createCustomizableNode("DemoSp5_WithAutDifferentConcern.Steps.AuthenticationConcern.LoginInfo.PerformAuthentication");
