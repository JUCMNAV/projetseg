package TimerWithAsyncTriggerAndTimeout.Instantiators.WithoutConcern;

import ram.reactiveworkflow.*;
import ram.workflow.*;

public class TimerWithAsyncTriggerAndTimeoutWorkflowInstantiator extends WorkflowInstantiator{
    public Workflow workflow=new Workflow();
    public EndNode _EP=new EndNode();
    public CustomizableNode _TheOuput=createCustomizableNode("TimerWithAsyncTriggerAndTimeout.Steps.WithoutConcern.TheInput.TheOuput");
    ...
    public CustomizableNode _ProcesstimerInput=createCustomizableNode("TimerWithAsyncTriggerAndTimeout.Steps.WithoutConcern.timerInput.ProcesstimerInput");
    ...
    public void linkNodesToNextNodes(){
        ...
        _Sp3.addNextNode(_ImplicitAndFork);
        _ImplicitAndFork.addNextNode(_Timer,"trigger");
        _ImplicitAndFork.addNextNode(_Ep3);
