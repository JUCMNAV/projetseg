...
/**
 * Provides supports for the management of (UCM elements converted to) CSM resources. A CSM resource may be deduced
 * implicitly from some UCM components and explictly from UCM demands and RA/RA instructions embeded in responsibility
 * metadata.
 * 
 * @author jack
 */
