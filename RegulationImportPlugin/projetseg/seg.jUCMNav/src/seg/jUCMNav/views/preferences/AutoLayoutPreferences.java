...
public class AutoLayoutPreferences {
    ...
    public final static String PATHNODEPREFIX = "PathNode"; //$NON-NLS-1$
    public final static String MAPPREFIX = "Map"; //$NON-NLS-1$
    // must start with cluster if we want them rendered.
    public final static String COMPONENTPREFIX = "cluster_ComponentRef"; //$NON-NLS-1$
